...
```
python -m pip install spacetime-crawler4py/packages/spacetime-2.1.1-py3-none-any.whl
python -m pip install -r spacetime-crawler4py/packages/requirements.txt
```
