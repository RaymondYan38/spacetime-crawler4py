...
def is_valid(url):
    try:
        prefixes = ["mailto:", "doi:", "javascript:", "skype:", "tel:", "https://www.ics.uci.edu/ugrad/honors", "https://archive.ics.uci.edu/ml", "http://tippersweb.ics.uci.edu",
                     "https://tippersweb.ics.uci.edu", "http://sli.ics.uci.edu/Ihler-Photos/Main", "http://sli.ics.uci.edu/~ihler/uai-data", "https://ics.uci.edu/~eppstein/pix",
                       "http://jujube.ics.uci.edu/localsearch/fuzzysearch", "http://duke.ics.uci.edu/~vibhav/langford", "http://www.ics.uci.edu/~agelfand/fig", "http://fano",
                         "https://fano", "http://alumni.ics.uci.edu/200", "https://password.ics", "http://hana.ics.uci.edu", "http://sprout.ics.uci.edu", "http://codeexchange.ics.uci.edu",
                         ]
